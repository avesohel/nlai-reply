...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Account created successfully! Welcome to ReplyBot!');
      } else {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <div>
              ...
              {errors.password && (
                <p className="mt-1 text-sm text-red-600">{(errors.password as any)?.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="mt-1 text-sm text-red-600">{(errors.confirmPassword as any)?.message}</p>
              )}
            </div>
          </div>
